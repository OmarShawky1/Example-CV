...
\address{+1(000) 000-0000 \\ San Francisco, CA} 
\address{\href{mailto:contact@X.com}{contact@X.com} \\ \href{https://linkedin.com/company/X}{linkedin.com/company/X} \\ \href{www.X.com}{www.X.com}}  %
...
\textbf{Software Enginner} \hfill Jan 2017 - Jan 2019\\
...
% \textbf{Sales Manager} \hfill Jan 2017 - Jan 2019\\
% Company Name \hfill \textit{San Francisco, CA}
%  \begin{itemize}
%     \itemsep -3pt {} 
%      \item Achieved X\% growth for XYZ using A, B, and C skills.
...
\begin{itemize}
    \item 	Actively write \href{https://www.X.com/blog/}{blog posts} and social media posts (\href{https://www.tiktok.com/@X}{TikTok}, \href{https://www.instagram.com/X/?hl=en}{Instagram}) viewed by over 20K+ job seekers per week to help people with best practices to land their dream jobs. 
...
\begin{itemize}
    \item Admin for the \href{https://discord.com/invite/WWbjEaZ}{X Discord community} with over 6000+ job seekers and industry mentors. Actively involved in facilitating online events, career conversations, and more alongside other admins and a team of volunteer moderators! 
\end{itemize}
